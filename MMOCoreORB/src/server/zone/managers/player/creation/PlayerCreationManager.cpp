...
bool PlayerCreationManager::createCharacter(ClientCreateCharacterCallback* callback) const {
	...
	box->setPromptText("Thank you for joining Relics of Corbantis. Please make sure to read our Rules and Expectations on the website before starting your adventure with us. May the Force Be With You!");
	
	String playerName = playerCreature->getFirstName();
 	StringBuffer zBroadcast;
 	zBroadcast << "\\#cc9966 Please welcome " << playerName << " to Relics!";
